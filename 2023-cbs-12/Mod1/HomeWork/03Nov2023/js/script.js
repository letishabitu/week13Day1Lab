const arrayOfWords = [["sport"], ["swim"], ["rain"],["coffee"], ["thanks"]];
//the length of the array of word. 
let q = 3;
const arrayOfMissingLetters = ["s _ o _  t", "s _ i _ ", "r _ _ n", "co_ _ ff", "t_ an_ s"]

//the length of answer array which will be the innter array
let p =2;
const arrayOfAnswers = [["p", "r"], ["w", "m"],["a", "i"],["e", "e"], ["h", "k"]]
